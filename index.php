...
<head>
    ...
    <link rel="stylesheet" href="external/css/index.css">
    ...
    <style>
        #hexCode {
            ...
            margin-top: 10px; /* Optional: to give space between the hex code and other elements */
...
<div class="container">
    <div class="col">
        ...
        <div id="output" class="output" style="display: none;">
            <strong>Hex Code:</strong> <span id="hexCode"></span>
        </div>
    </div>
</div>
